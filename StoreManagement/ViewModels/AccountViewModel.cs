...
namespace StoreManagement.ViewModels
{
    public class AccountViewModel : BaseViewModel
    {
        ...
        public AccountViewModel()
        {
            ...
            TextChangeCommand = new RelayCommand<TextBlock>((para) => true, para => OnTextChange(para));
        }

        private void OnTextChange(TextBlock para)
        {
            para.Text = null;
        }
        //home window
        ...
        private void InfoAcc_Save(InfoAccountWindow para)
        {
            ...
            {
                para.displayname_error.Text = "Please enter display name!";
            ...
            {
                para.phone_error.Text = "Please enter phone number!";
        ...
        private void ChangePassword(ChangePasswordWindow para)
        {
            ...
            {
                para.username_error.Text = "Please enter username!";
                para.txtUsername.Focus();
                return;
            }
            if (string.IsNullOrEmpty(para.pwbPassword.Password))
            {
                para.password_error.Text = "Please enter password!";
                para.pwbPassword.Focus();
                return;
            }
            if (string.IsNullOrEmpty(para.pwbNewPassword.Password))
            {
                para.newpassword_error.Text = "Please enter new password!";
                para.pwbPassword.Focus();
                return;
            }
            if (string.IsNullOrEmpty(para.pwbConfirmNewPassword.Password))
            {
                para.newpassagain_error.Text = "Please enter new password again!";
